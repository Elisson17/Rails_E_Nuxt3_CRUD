...
class ProdutosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create produto" do
    assert_difference("Produto.count") do
      post produtos_url, params: { produto: { categoria: @produto.categoria, descri: @produto.descri, preco: @produto.preco, quantidade: @produto.quantidade, titulo: @produto.titulo } }, as: :json
    end
  ...
  test "should update produto" do
    patch produto_url(@produto), params: { produto: { categoria: @produto.categoria, descri: @produto.descri, preco: @produto.preco, quantidade: @produto.quantidade, titulo: @produto.titulo } }, as: :json
    assert_response :success
  end
